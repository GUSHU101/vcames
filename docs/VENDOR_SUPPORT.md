...
| Xiaomi/Redmi/POCO | Qualcomm（首批）、MediaTek（后续） | candidate | MIUI/原厂 vendor provider、camera lib 集合、buffer layout |
...
不以“Pixel 型号白名单”或“Android 大版本”替代上述探测，也不承诺两个厂商的所有型号。
